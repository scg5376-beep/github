...
# 판 표시 — 도구를 내려보낼 때 zip 이름은 같고 내용만 달라서, 열어서 해시를 재기 전엔
# 어느 판인지 알 수 없었다. 다른 판인데 같은 줄 알고 안 덮으면 그대로 어긋난 채 간다.
# 품목 레포 쪽이 제안한 것이다 (2026-09-03). 고칠 때마다 여기를 올린다.
판 = "2026-09-03 · 갱신7 (값·로직 분리 · 면제 종류 · 기록 성격 · 판 표시)"

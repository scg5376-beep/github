...
CHAN_LEVELS = {
    ...
    "판매/스마트스토어": [
        ...
        ("중급 · 운영", "정산·상품 규칙·페널티·도용·사기", ["/guide/quick-settlement.html", "/guide/store-listing-rules.html", "/guide/store-penalty.html", "/guide/store-ipr.html", "/guide/store-scam.html", "/guide/delivery-fees.html"]),
    ...
    "카카오/채널": [
        ...
        ("중급 · 운영", "채널 개념과 비즈멤버십", ["/guide/kakao-channel.html", "/guide/kakao-membership.html"]),
    ],
    "당근/비즈프로필": [

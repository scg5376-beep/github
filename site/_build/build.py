...
TRACK_INFO = {
    "동네 매장": {"who": "식당·카페·미용실·안경원·병원·학원", "lead": "손님이 지도와 플레이스로 들어와요. 무료이고 근거가 센 것부터, 돈 드는 것은 뒤에 놓았어요.",
                "why": {"시작 가이드": "무엇부터 할지, 왜 그 순서인지 한 장으로.", "관련법": "광고를 켜기 전에 표시와 처리방침 한 번.", "플레이스 등록": "동네 손님이 가장 먼저 보는 곳이고 무료예요.", "플레이스 순위": "인기도는 거리를 이길 수 있어요. 리뷰의 말이 검색어.", "리뷰 답글": "독립 매장에서 매출을 움직였어요. 답글은 정중함보다 내용.", "검색 화면": "어디가 광고이고 어디가 무료인지 알아야 대행사 말을 가려요.", "블로그": "가게 주제 하나로 꾸준히. 일상 글로 개수를 채우지 않아요.", "파워링크": "동네 키워드는 칸이 3개예요. 앞 단계가 돼 있어야 안 새요.", "12주 기록": "한 주에 하나만 바꾸고 적어요."}},
    "온라인 판매": {"who": "스마트스토어·쿠팡·자사몰", "lead": "손님이 장터에서 찾고 장터에서 사요. 법이 요구하는 것이 전부 걸리고, 수수료가 어디에 붙는지가 먼저예요.",
                "why": {"시작 가이드": "어느 장터부터, 왜 그 순서인지 한 장으로.", "관련법": "통신판매업 신고, 홈페이지 표시, 청약철회, 처리방침. 전부 법 원문.", "수수료": "스마트스토어는 두 갈래, 쿠팡은 카테고리 고정, 인스타그램 안 결제는 안 돼요.", "도메인": "빌더·오픈마켓·직접 구축 세 길. 공짜 호스팅은 장사에 못 써요.", "홈페이지 노출": "등록은 노출 조건이 아니고, 제목은 페이지마다 달라야 해요.", "블로그": "직접 데려온 주문을 만드는 길. 비체험 원고는 미노출.", "인스타그램": "제품 태그는 무료, 링크를 걸어도 도달은 안 떨어져요.", "광고": "메타 광고는 소재를 바꾸면 학습이 처음부터예요.", "12주 기록": "직접 데려온 주문 비율이 첫 줄이에요."}},
    "예약·상담": {"who": "학원·공방·상담·시술", "lead": "손님이 검색해서 비교하고, 문의하고, 예약해요. 문의 폼이 있는 순간 개인정보 규정이 걸려요.",
                "why": {"시작 가이드": "문의가 들어오는 길부터 한 장으로.", "관련법": "문의 폼이 있으니 처리방침과 보호책임자.", "플레이스 등록": "예약과 문의 버튼이 여기 있어요.", "홈페이지 노출": "제목이 다 같은 빌더 사이트가 여기서 걸려요.", "구글 글쓰기": "건강에 닿는 업종은 가중치가 다르고, 경험이 드러나야 해요.", "리뷰 답글": "시술 업종은 비포 앤 애프터 사진이 두 플랫폼에서 막혀요.", "AI 답변": "질문으로 찾는 업종이라 AI 브리핑의 재료가 되는 리뷰가 중요해요.", "12주 기록": "문의 수를 세요. 노출 수는 성과가 아니에요."}},
    "외국 손님": {"who": "관광지·외국인 단골 가게", "lead": "외국 손님은 한국어로 검색하지 않고 구글 지도를 열어요. 네이버 플레이스를 먼저 채운 뒤 같은 재료로 구글을 채워요.",
                "why": {"시작 가이드": "외국 손님이 여는 화면부터 한 장으로.", "플레이스 등록": "재료가 여기서 나와요. 두 번 쓰는 일이에요.", "구글 프로필": "프로필은 하나만, 설명에 링크 금지.", "도메인": "구글 검색과 인스타그램 판매 자격이 도메인을 요구해요.", "홈페이지 노출": "구글은 기술 요건만 맞으면 색인이 무료예요.", "인스타그램": "사진으로 보여 주는 게 언어를 넘어요.", "12주 기록": "어느 길로 왔는지 세요."}},
}

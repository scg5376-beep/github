...
PLAT_ORDER = {
    "네이버": [("/guide/place.html", "플레이스 등록", "무료이고, 네이버가 사업주의 의무로 적은 유일한 일이에요."), ("/guide/place-owner.html", "주인 변경", "「이미 등록된 업체」면 새로 만들지 말고 권한을 옮겨요. ARS·서류."), ("/guide/rank-drop.html", "순위 떨어짐", "하루 변동·정보 변경·리뷰 감소·대행사 작업·필터·거리, 여섯 가지 순서."), ("/guide/map-missing.html", "지도에 안 떠요", "이름 검색에 나오면 등록은 된 것. 마커는 자동이라 요청으로 못 넣어요."), ("/guide/place-photos.html", "사진 규칙", "사장님 사진이 먼저, 수집 사진은 못 지워요. 1장이면 거리뷰가 붙어요."), ("/guide/talktalk.html", "톡톡 설정", "무료, 상담시간·자동 인사말·응답률 배지·단체 메시지 월 1회."), ("/guide/naver-clip.html", "클립", "장소 태그가 있어야 플레이스에 붙어요. 방문 인증은 영수증이 있어야."), ("/guide/smartplace-help-index.html", "도움말 색인 132", "스마트플레이스 도움말 번호·제목을 주제별로. 화면에 뜬 말로 찾기."), ("/guide/reviews.html", "리뷰 답글", "돈 안 드는 것 가운데 효과가 측정된 일. 리뷰의 말이 검색어가 돼요."), ("/guide/reply-examples.html", "답글 예시 24개", "상황 12가지, 복사해 괄호만 바꿔 쓰는 문장."), ("/guide/review-penalty.html", "리뷰 어뷰징 페널티", "조작 한 건이면 리뷰 전부 미노출. 직원이 대신 찍기·점수 요구도 해당."), ("/guide/disclosure.html", "체험단 표시", "자리·모양·말·언어 넷. 「체험단」「AD」는 부적절한 예."), ("/guide/star-rating.html", "별점 부활", "2026년 4월부터 입력, 7월부터 표시. 평균은 10명부터, 사장님 ON/OFF."), ("/guide/hair-salon.html", "미용실 홍보 순서", "인기 미용실은 예약·Npay 결제 기록으로 정해요. 돈 안 드는 5단계."), ("/guide/academy.html", "학원 홍보 순서", "광고에 적을 네 가지부터. 과정별 수강료·예약 상담·한 과목 블로그."), ("/guide/reservation-settlement.html", "예약금 정산·수수료", "이용 완료 뒤 1영업일, 매장방문 결제는 2영업일. 영세 1.80%·0.80%."), ("/guide/reservation-help-index.html", "예약주문 도움말 색인", "제작·검수·정산·환불·네이버 주문 도움말 146개를 번호로."), ("/guide/seo.html", "검색 화면", "광고 칸과 무료 칸을 알아야 「상위 노출 보장」을 가려요."), ("/guide/blog.html", "블로그", "한 주제로 꾸준히. 언급수가 플레이스 인기도로 돌아와요."), ("/guide/blog-help-index.html", "블로그 도움말 색인", "검색 노출·발행·내돈내산·가게 연결 도움말 114개를 번호로."), ("/guide/powerlink.html", "파워링크", "앞 단계가 돼 있어야 클릭이 손님이 돼요. 여기서 처음 돈이 들어요."), ("/guide/agency-contract.html", "대행사 위약금·해지", "위약금 과다 청구가 분쟁의 67%. 조정원 창구와 계약 전 넷."), ("/guide/naver-ads-help-index.html", "광고주센터 도움말 색인", "파워링크·플레이스광고·결제·검토 질문 번호를 분류별로.")],
    ...
    "당근": [("/daangn/1-profile.html", "비즈프로필", "무료로 만들고 사업자 인증까지. 소식은 홈 피드에 무료로 나가요."), ("/daangn/2-coupon.html", "단골과 쿠폰", "단골 알림·단골 전용 쿠폰·후기 답글. 전부 무료."), ("/guide/daangn-reviews.html", "후기 규칙", "후기에 대가를 걸면 안 돼요. 신고할 수 있는 후기와 안 지워지는 후기.")],
...
HOWTO_INDEX = [
    ("naver", "네이버", [
        ...
        ("예약주문 도움말 색인", "/guide/reservation-help-index.html", "가입·제작·검수·정산·환불·네이버 주문 질문 146개"),
        ("블로그 도움말 색인", "/guide/blog-help-index.html", "검색 노출·발행·내돈내산·플레이스 연결 질문 114개"),
...
GUIDE_TO_HOWTO = {
    "/guide/place.html": ["/local/2-place.html", "/local/3-rank.html"], "/guide/place-owner.html": ["/local/2-place.html"], "/guide/agency-contract.html": ["/local/8-powerlink.html"], "/guide/followers.html": ["/foreign/6-instagram.html"], "/guide/rank-drop.html": ["/local/3-rank.html"], "/guide/disclosure.html": ["/local/4-reviews.html"], "/guide/store-scam.html": ["/online/1-start.html"], "/guide/map-missing.html": ["/local/2-place.html"], "/guide/star-rating.html": ["/local/4-reviews.html"], "/guide/smartplace-help-index.html": ["/local/2-place.html"], "/guide/smartstore-faq-start.html": ["/online/1-start.html"], "/guide/smartstore-faq-run.html": ["/online/2-fees.html"], "/guide/smartstore-faq-orders.html": ["/online/2-fees.html"], "/guide/quick-settlement.html": ["/online/2-fees.html"], "/guide/store-penalty.html": ["/online/2-fees.html"], "/guide/store-listing-rules.html": ["/online/1-start.html"], "/guide/daangn-reviews.html": ["/daangn/2-coupon.html"], "/guide/naver-ads-help-index.html": ["/local/8-powerlink.html"], "/guide/voucher-2026.html": ["/local/9-record.html"], "/guide/kakao-guide-index.html": ["/kakao/1-channel.html"], "/guide/place-photos.html": ["/local/3-rank.html"], "/guide/reservation-settlement.html": ["/service/2-place.html"], "/guide/reservation-help-index.html": ["/service/2-place.html"], "/guide/talktalk.html": ["/service/2-place.html", "/local/4-reviews.html"], "/guide/naver-clip.html": ["/local/3-rank.html", "/youtube/1-channel.html"], "/guide/review-penalty.html": ["/local/4-reviews.html"], "/guide/blog-help-index.html": ["/local/6-blog.html"], "/guide/reviews.html": ["/local/4-reviews.html"], "/guide/reply-examples.html": ["/local/4-reviews.html"], "/guide/hair-salon.html": ["/service/2-place.html"], "/guide/academy.html": ["/service/2-place.html"],

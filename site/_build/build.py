...
PLAT_ORDER = {
    "네이버": [("/guide/place.html", "플레이스 등록", "무료이고, 네이버가 사업주의 의무로 적은 유일한 일이에요."), ("/guide/place-owner.html", "주인 변경", "「이미 등록된 업체」면 새로 만들지 말고 권한을 옮겨요. ARS·서류."), ("/guide/rank-drop.html", "순위 떨어짐", "하루 변동·정보 변경·리뷰 감소·대행사 작업·필터·거리, 여섯 가지 순서."), ("/guide/reviews.html", "리뷰 답글", "돈 안 드는 것 가운데 효과가 측정된 일. 리뷰의 말이 검색어가 돼요."), ("/guide/reply-examples.html", "답글 예시 24개", "상황 12가지, 복사해 괄호만 바꿔 쓰는 문장."), ("/guide/disclosure.html", "체험단 표시", "자리·모양·말·언어 넷. 「체험단」「AD」는 부적절한 예."), ("/guide/hair-salon.html", "미용실 홍보 순서", "인기 미용실은 예약·Npay 결제 기록으로 정해요. 돈 안 드는 5단계."), ("/guide/academy.html", "학원 홍보 순서", "광고에 적을 네 가지부터. 과정별 수강료·예약 상담·한 과목 블로그."), ("/guide/seo.html", "검색 화면", "광고 칸과 무료 칸을 알아야 「상위 노출 보장」을 가려요."), ("/guide/blog.html", "블로그", "한 주제로 꾸준히. 언급수가 플레이스 인기도로 돌아와요."), ("/guide/powerlink.html", "파워링크", "앞 단계가 돼 있어야 클릭이 손님이 돼요. 여기서 처음 돈이 들어요."), ("/guide/agency-contract.html", "대행사 위약금·해지", "위약금 과다 청구가 분쟁의 67%. 조정원 창구와 계약 전 넷.")],
    ...
    "판매": [("/guide/before-selling.html", "관련법", "신고와 표시가 먼저예요. 반나절이면 돼요."), ("/guide/store-scam.html", "입점 사기", "「네이버 입점 담당」 전화는 네이버가 아니에요. 입점은 직접 가입."), ("/guide/selling.html", "수수료", "어디에 얼마나 붙는지 알고 장터를 골라요."), ("/guide/delivery-fees.html", "배달앱", "식당이면 배달앱 수수료 구간부터 확인.")],
...
GUIDE_TO_HOWTO = {
    "/guide/place.html": ["/local/2-place.html", "/local/3-rank.html"], "/guide/place-owner.html": ["/local/2-place.html"], "/guide/agency-contract.html": ["/local/8-powerlink.html"], "/guide/followers.html": ["/foreign/6-instagram.html"], "/guide/rank-drop.html": ["/local/3-rank.html"], "/guide/disclosure.html": ["/local/4-reviews.html"], "/guide/store-scam.html": ["/online/1-start.html"], "/guide/reviews.html": ["/local/4-reviews.html"], "/guide/reply-examples.html": ["/local/4-reviews.html"], "/guide/hair-salon.html": ["/service/2-place.html"], "/guide/academy.html": ["/service/2-place.html"],

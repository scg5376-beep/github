...
GUIDE_TO_HOWTO = {
    "/guide/place.html": ["/local/2-place.html", "/local/3-rank.html"], "/guide/place-owner.html": ["/local/2-place.html"], "/guide/agency-contract.html": ["/local/8-powerlink.html"], "/guide/followers.html": ["/foreign/6-instagram.html"], "/guide/rank-drop.html": ["/local/3-rank.html"], "/guide/disclosure.html": ["/local/4-reviews.html"], "/guide/store-scam.html": ["/online/1-start.html"], "/guide/map-missing.html": ["/local/2-place.html"], "/guide/star-rating.html": ["/local/4-reviews.html"], "/guide/smartplace-help-index.html": ["/local/2-place.html"], "/guide/reviews.html": ["/local/4-reviews.html"], "/guide/reply-examples.html": ["/local/4-reviews.html"], "/guide/hair-salon.html": ["/service/2-place.html"], "/guide/academy.html": ["/service/2-place.html"],

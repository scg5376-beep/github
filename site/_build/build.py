...
PLAT_ORDER = {
    ...
    "판매": [("/guide/before-selling.html", "관련법", "신고와 표시가 먼저예요. 반나절이면 돼요."), ("/guide/selling.html", "수수료", "어디에 얼마나 붙는지 알고 장터를 골라요."), ("/guide/delivery-fees.html", "배달앱", "식당이면 배달앱 수수료 구간부터 확인.")],
...
GUIDE_TO_HOWTO = {
    "/guide/place.html": ["/local/2-place.html", "/local/3-rank.html"], "/guide/place-owner.html": ["/local/2-place.html"], "/guide/agency-contract.html": ["/local/8-powerlink.html"], "/guide/followers.html": ["/foreign/6-instagram.html"], "/guide/rank-drop.html": ["/local/3-rank.html"], "/guide/disclosure.html": ["/local/4-reviews.html"], "/guide/reviews.html": ["/local/4-reviews.html"], "/guide/reply-examples.html": ["/local/4-reviews.html"], "/guide/hair-salon.html": ["/service/2-place.html"], "/guide/academy.html": ["/service/2-place.html"],

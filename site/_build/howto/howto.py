...
COURSE = {
    ...
    "kakao":   (3, ["카카오톡 안의 가게 채널", "무료 소식과 유료 메시지의 구분", "카카오맵에 나오는 매장 정보와 무료 전용번호"], '<a href="/local/9-record.html">12주 기록</a>'),
    "daangn":  (3, ["당근 동네지도와 검색에 나오는 비즈프로필", "인증 표시", "무료로 나가는 소식", "단골과 쿠폰", "동네를 골라 하루 1만 원으로 켜 본 광고와 그 성과표"], '<a href="/kakao/1-channel.html">카카오톡 채널 만들기</a>'),
...
def page(track, step_no, sub, title, desc, lead, prep, minutes, cost, do, done, blocked, why, nxt, sources, order, date="2026-09-14", note="", result="", who="", cat_sub=None):
    ...
    TOP = {"local": "동네 매장", "online": "온라인 판매", "service": "예약·상담", "foreign": "외국 손님", "kakao": "카카오", "daangn": "당근", "youtube": "유튜브"}[track]
